...
## a) Pubkey today
### Online banking
* Parties involved: Me and my bank
* Public key used:
* Private key used:

Reference: OP:n digipalveluiden turvaominaisuudet: https://www.op.fi/turvallinen-asiointi/op-verkkopalvelun-turvaominaisuudet
  
### Whatsapp
* Parties involved: Me, a friend, Whatsapp
* Public key used: WhatsApp generates a unique public key for each user, which is shared with the contacts you communicate with to encrypt messages.
* Prive key used: Each user’s private key decrypts incoming messages, ensuring only the intended recipient can read them.

Reference: About end-to-end ecnryption, https://faq.whatsapp.com/820124435853543
