...
I used Hashcat like in the previous assignents and now I just use another hash mode. I used command: 'hashcat -m 1000 hashes.txt rockyou.txt -o solved5'. The password is 'monkey'.
