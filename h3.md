...
* STEP 5) I decided to test with some other password. I checked what are the last password in the rockyou.txt list and found `ciocolatax`. I used a net site to hash it and the decrypted it with same command. Now I got some speed. And estimated time to solve is 15 days.

![image](https://github.com/user-attachments/assets/d246537b-b1ce-4f40-80e5-4502ce7ee35c)
...
I used Hashcat like in the previous assignents and now I just use another hash mode 
...
* STEP 6) Extracted the has to a new file tero.zip.hash. Then I did a dictionary attack to that hash file. You can see the password in the line that is in brown. Password: `butterfly`.
