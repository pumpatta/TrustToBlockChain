...
* Previous Output: The source of the funds being spent in this transaction.
* ScriptSig: A script that provides the necessary data to satisfy the conditions set by the previous output's ScriptPubKey.
